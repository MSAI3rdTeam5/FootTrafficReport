...
Usage:
  ...
  2) (추가) python rtp_pipeline.py [RTP_HOST] [RTP_PORT] [RTMP_URL] [CCTV_ID]
...
if __name__ == "__main__":
    """
    1) 기본형:
       python rtp_pipeline.py
         => rtp://media-sfu:40000 + rtmp://srs:1935/live/mosaic_sfu + sfu_test

       python rtp_pipeline.py rtp://media-sfu:40000 rtmp://srs:1935/live/test my_cctv

    2) (추가) [RTP_HOST] [RTP_PORT] [RTMP_URL] [CCTV_ID]
       python rtp_pipeline.py media-sfu 40012 rtmp://srs:1935/live/mosaic_sfu my_cctv
       => rtp_url = "rtp://media-sfu:40012"
    """

    rtp_url = os.getenv("RTP_URL", "rtp://media-sfu:40000")
    rtmp_url = os.getenv("RTMP_URL", "rtmp://srs:1935/live/mosaic_sfu")
    cctv_id = "sfu_test"
