      ...
      <div className="pt-16 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(processedStream || remoteStream) && (
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border dark:border-gray-700 mb-6">
            <h2 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-200">웹캠 실시간 미리보기 (모자이크 처리됨)</h2>
            <div className="flex flex-col md:flex-row gap-4">
              <video ref={localVideoRef} autoPlay playsInline muted className="w-full md:w-[320px] bg-black" />
              <video ref={remoteVideoRef} autoPlay playsInline className="w-full md:w-[320px] bg-gray-300" />
            </div>
            <button onClick={handleWebcamDisconnect} className="mt-4 px-4 py-2 bg-red-500 text-white rounded-button dark:bg-red-600">
              웹캠 연결 종료
            </button>
          </div>
        )}
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border dark:border-gray-700 mb-6">
          <h2 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-200">모자이크 영상 (WebRTC)</h2>
          ...
          <div className="mt-4">
              <video
                ...
                playsInline
                muted
                className="w-full md:w-[320px] bg-black"
              />
